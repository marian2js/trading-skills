...
ExampleEarningsCalendarAdapter = load_adapter_class(
    "earnings_example_adapter",
    "providers/example/adapter.py",
    "ExampleEarningsCalendarAdapter",
)
FMPEarningsCalendarAdapter = load_adapter_class(
...
def analyze_events(events: list[dict], watchlist: list[str]) -> tuple[dict, list[str]]:
...
def main() -> int:
    ...
    try:
        ...
        analysis, coverage_warnings = analyze_events(events, watchlist)
