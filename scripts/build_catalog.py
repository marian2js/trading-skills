...
SKILL_PATH_ORDER = [
    "market-context/macro-event-analysis",
    "market-context/earnings-preview",
    "market-context/market-regime-analysis",
    "idea-discovery/watchlist-review",
    "idea-discovery/catalyst-map",
    "thesis-validation/thesis-validation",
    "thesis-validation/evidence-gap-check",
    "trade-construction/risk-reward-sanity-check",
    "trade-construction/portfolio-concentration",
    "trade-construction/position-sizing",
    "trade-construction/execution-plan-check",
    "position-oversight/position-management",
    "review-learning/post-trade-review",
    "review-learning/journal-pattern-analyzer",
    "workflows/pre-trade-check",
    "workflows/earnings-trade-prep",
    "workflows/portfolio-risk-review",
    "workflows/post-trade-debrief",
    "live-trade/etoro",
]
...
SKILL_DOC_MAP = {
    ...
    "post-trade-debrief": "docs/examples/post-trade-debrief-walkthrough.md",
    ...
    "position-management": "docs/examples/position-management-walkthrough.md",
    "journal-pattern-analyzer": "docs/examples/journal-pattern-analyzer-walkthrough.md",
